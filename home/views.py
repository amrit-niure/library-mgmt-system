...
def project_plan(request):
    """View to display the project plan from README.md"""
    try:
        ...
        context = {
            ...
            'title': 'PRT582 Software Project Plan'
        }
        
        return render(request, 'project_plan.html', context)
    
    except FileNotFoundError:
        # Fallback content if README is not found
        context = {
            'html_content': '<h1>Project Plan</h1><p>README file not found.</p>',
            'title': 'Project Plan - Error'
        }
        return render(request, 'project_plan.html', context)
    except Exception as e:
        # Handle any other errors
        context = {
            'html_content': f'<h1>Error</h1><p>An error occurred: {str(e)}</p>',
            'title': 'Project Plan - Error'
        }
        return render(request, 'project_plan.html', context)
